...
@NgModule({
    providers: [
        ApiServiceProxies.GeneralLedgerAccountsServiceProxy,               
        ...
        ApiServiceProxies.LookupPagesServiceProxy,        
        ApiServiceProxies.TransferBudgetItemsServiceProxy,        
        ApiServiceProxies.TransferBudgetsServiceProxy,        
        ApiServiceProxies.EKPOsServiceProxy,        
        ApiServiceProxies.EKKOsServiceProxy,        
        ApiServiceProxies.JobSynchronizesServiceProxy,        
        ApiServiceProxies.CostCentersServiceProxy,        
        ApiServiceProxies.DataProductionsServiceProxy,        
        ApiServiceProxies.MaterialRequestsServiceProxy,        
        ApiServiceProxies.MaterialsServiceProxy,        
        ApiServiceProxies.UNSPSCsServiceProxy,        
        ApiServiceProxies.MaterialGroupsServiceProxy,        
        ApiServiceProxies.GeneralLedgerMappingsServiceProxy,        
        ApiServiceProxies.EnumTablesServiceProxy,        
