...
using Adaro.Centralize.MultiTenancy.HostDashboard;
...
namespace Adaro.Centralize.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(CentralizeDbContext context, SubscriptionPayment subscriptionPayment)
        {
