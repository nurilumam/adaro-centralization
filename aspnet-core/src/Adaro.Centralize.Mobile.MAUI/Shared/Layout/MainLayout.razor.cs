...
using Adaro.Centralize.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Adaro.Centralize.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Adaro.Centralize.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Adaro.Centralize.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
