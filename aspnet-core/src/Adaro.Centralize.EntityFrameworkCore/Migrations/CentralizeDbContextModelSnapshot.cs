...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adaro.Centralize.Finance.TransferBudget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Adaro.Centralize.Finance.TransferBudgetDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TransferBudgetDetails");
                });
            ...
            modelBuilder.Entity("Adaro.Centralize.LookupArea.LookupPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Adaro.Centralize.ReportArea.RptProcurementAdjust", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("DayAdjust")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PurchasingDocument")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("RptProcurementAdjusts");
                });
            ...
            modelBuilder.Entity("Adaro.Centralize.SAPConnector.CostCenter", b =>
                {
                    ...
                    b.Property<string>("CostCenterShort")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Adaro.Centralize.SAPConnector.GeneralLedgerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double?>("CommitmentActuals")
                        .HasColumnType("float");

                    b.Property<double?>("ConsumableBudget")
                        .HasColumnType("float");

                    b.Property<double?>("ConsumedBudget")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("FundsCenter")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("FundsCenterDescription")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Adaro.Centralize.SAPConnector.ZMM020R", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DeletionIndicator")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
                    ...
                    b.Property<string>("FirstApprovalName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("ItemRequisition")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
                    ...
                    b.Property<string>("LastApprovalName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("OutlineAgreement")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("PrincAgreementItem")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("PurchasingInfoRec")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<double?>("QuantityRequested")
                        .HasColumnType("float");

                    b.Property<double?>("QuantityService")
                        .HasColumnType("float");

                    b.Property<string>("ReleaseIndicator")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("UnitOfMeasureService")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<double?>("ValuationPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Adaro.Centralize.SAPConnector.ZMM021R", b =>
                {
                    ...
                    b.Property<string>("CollectiveNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("CommentVendor")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FuelAllocation")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("MaterialService")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<double?>("NetOrderValue")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("PICDept")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("PICSect")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("POApprovalName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<DateTime?>("POFirstApprovalDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("POLastApprovalDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("PRFinalFirstApprovalDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("PRFinalLastApprovalDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("PurchasingDocType")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("PurchasingDocTypeDescription")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Adaro.Centralize.Finance.TransferBudgetDetail", b =>
                {
                    b.HasOne("Adaro.Centralize.SAPConnector.CostCenter", "CostCenterFk")
                        .WithMany()
                        .HasForeignKey("CostCenterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adaro.Centralize.SAPConnector.GeneralLedgerAccount", "GeneralLedgerAccountFk")
                        .WithMany()
                        .HasForeignKey("GeneralLedgerAccountId");

                    b.Navigation("CostCenterFk");

                    b.Navigation("GeneralLedgerAccountFk");
                });
