...
namespace Adaro.Centralize.Organizations
{
    public class UserOrganizationUnitRepository : CentralizeRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<CentralizeDbContext> dbContextProvider)
