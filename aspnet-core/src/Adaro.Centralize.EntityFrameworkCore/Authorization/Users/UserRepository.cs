...
{
    public class UserRepository : CentralizeRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<CentralizeDbContext> dbContextProvider)
