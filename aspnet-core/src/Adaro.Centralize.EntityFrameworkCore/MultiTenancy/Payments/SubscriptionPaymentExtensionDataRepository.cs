...
using Adaro.Centralize.EntityFrameworkCore.Repositories;

namespace Adaro.Centralize.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : CentralizeRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<CentralizeDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
