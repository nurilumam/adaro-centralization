...
using Adaro.Centralize.Web.Public.Startup;
using Adaro.Centralize.Web.Session;
using Adaro.Centralize.Web.UiCustomization;

namespace Adaro.Centralize.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CentralizeViewComponent
    {
