...
namespace Adaro.Centralize.Web.Public.Startup
{
    [DependsOn(
        typeof(CentralizeWebCoreModule)
    )]
    public class CentralizeWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public CentralizeWebFrontEndModule(IWebHostEnvironment env, CentralizeEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CentralizeWebFrontEndModule).GetAssembly());
        }
    }
}
