...
using Adaro.Centralize.Authorization.Users.Profile.Cache;
...
using Adaro.Centralize.Timing;

namespace Adaro.Centralize.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CentralizeAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Adaro.Centralize",
