...
namespace Adaro.Centralize.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : CentralizeAppServiceBase, IDashboardCustomizationAppService
    {
