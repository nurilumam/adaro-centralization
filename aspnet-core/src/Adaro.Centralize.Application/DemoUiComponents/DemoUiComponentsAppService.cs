...
using Adaro.Centralize.DemoUiComponents.Dto;

namespace Adaro.Centralize.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CentralizeAppServiceBase, IDemoUiComponentsAppService
    {
