...
using Adaro.Centralize.Auditing.Exporting;
using Adaro.Centralize.Authorization;
using Adaro.Centralize.Authorization.Users;
using Adaro.Centralize.Dto;
using Adaro.Centralize.EntityHistory;
using EntityHistoryHelper = Adaro.Centralize.EntityHistory.EntityHistoryHelper;

namespace Adaro.Centralize.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CentralizeAppServiceBase, IAuditLogAppService
    {
