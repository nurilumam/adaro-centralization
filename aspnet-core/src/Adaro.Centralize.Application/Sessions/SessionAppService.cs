...
{
    public class SessionAppService : CentralizeAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = CentralizeConsts.Currency,
                        CurrencySign = CentralizeConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = CentralizeConsts.AllowTenantsToChangeEmailSettings,
