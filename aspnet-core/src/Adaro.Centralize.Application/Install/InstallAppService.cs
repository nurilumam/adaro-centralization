...
using Adaro.Centralize.Migrations.Seed;
...
namespace Adaro.Centralize.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CentralizeAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CentralizeDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{CentralizeConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CentralizeConsts.ConnectionStringName}", constring);
        }
