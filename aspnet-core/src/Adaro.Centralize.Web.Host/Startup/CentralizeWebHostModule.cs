...
namespace Adaro.Centralize.Web.Startup
{
    ...
    public class CentralizeWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CentralizeWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CentralizeWebHostModule).GetAssembly());
        }
