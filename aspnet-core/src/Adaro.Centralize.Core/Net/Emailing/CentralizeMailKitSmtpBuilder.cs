...
{
    public class CentralizeMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public CentralizeMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(CentralizeConsts.LocalizationSourceName, name);
        }
    }
}