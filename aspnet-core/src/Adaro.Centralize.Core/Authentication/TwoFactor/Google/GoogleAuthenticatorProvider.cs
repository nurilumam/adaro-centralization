...
namespace Adaro.Centralize.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CentralizeServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Adaro.Centralize", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
