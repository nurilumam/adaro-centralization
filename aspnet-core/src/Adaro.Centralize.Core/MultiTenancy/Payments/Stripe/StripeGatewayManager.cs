...
{
    public class StripeGatewayManager : CentralizeServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Centralize";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CentralizeConsts.Currency;
        }
