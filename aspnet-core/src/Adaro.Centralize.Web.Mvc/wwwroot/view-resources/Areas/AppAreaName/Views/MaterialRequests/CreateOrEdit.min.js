(function () {
    $(function () {
        ...
        _$materialRequestInformationForm.validate();
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/MaterialRequests/_MaterialRequestUNSPSCLookupTableModal.js',
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/MaterialRequests/_MaterialRequestGeneralLedgerMappingLookupTableModal.js',
        ...
        $('.date-picker').daterangepicker({
            ...
            _MaterialRequestunspscLookupTableModal.open({ id: materialRequest.unspscId, displayName: materialRequest.unspscDisplayProperty }, function (data) {
        ...
        $('#OpenGeneralLedgerMappingLookupTableButton').click(function () {
            ...
            _MaterialRequestgeneralLedgerMappingLookupTableModal.open({ id: materialRequest.valuationClassId, displayName: materialRequest.generalLedgerMappingDisplayProperty }, function (data) {
                _$materialRequestInformationForm.find('input[name=generalLedgerMappingDisplayProperty]').val(data.displayName); 
        ...
        function save(successCallback) {
            ...
            if ($('#MaterialRequest_ValuationClassId').prop('required') && $('#MaterialRequest_ValuationClassId').val() == '') {
            ...
            var materialRequest = _$materialRequestInformationForm.serializeFormToObject();
			 ...
			 abp.ui.setBusy();
			 _materialRequestsService.createOrEdit(
				materialRequest
			 ).done(function () {
                            ...
                            $("#MaterialRequest_Picture_Remove").click(function () {
                                abp.message.confirm(
                                    ...
                                    function (isConfirmed) {
                                        if (isConfirmed) {
                                            var MaterialRequest = _$materialRequestInformationForm.serializeFormToObject();
                                            _materialRequestsService.removePictureFile({
