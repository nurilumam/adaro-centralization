var DynamicEntityPropertyManager = (function () {
  return function () {
    ...
    let _dynamicPropertiesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/AppAreaName/Views/_Bundles/manage-dynamic-entity-property-values-modal.min.js',
