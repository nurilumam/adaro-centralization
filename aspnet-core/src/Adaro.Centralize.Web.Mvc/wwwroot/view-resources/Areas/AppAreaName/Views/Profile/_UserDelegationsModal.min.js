(function ($) {
  app.modals.UserDelegationsModal = function () {
    ...
    var _createNewUserDelegationModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/Profile/CreateNewUserDelegationModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Profile/_CreateNewUserDelegationModal.js',
