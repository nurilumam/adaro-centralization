(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/WebhookSubscription/EditModal',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  window.location = '/AppAreaName/WebhookSubscription/WebhookEventDetail/' + data.record.webhookEventId;
                },
              },
            ],
          },
