(function () {
    $(function () {
        ...
        _$materialInformationForm.validate();
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Materials/_MaterialMaterialGroupLookupTableModal.js',
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Materials/_MaterialGeneralLedgerMappingLookupTableModal.js',
        ...
        $('.date-picker').daterangepicker({
            ...
            _MaterialmaterialGroupLookupTableModal.open({ id: material.materialGroupId, displayName: material.materialGroupDisplayProperty }, function (data) {
        ...
        $('#OpenUNSPSCLookupTableButton').click(function () {
            ...
            _MaterialunspscLookupTableModal.open({ id: material.unspscId, displayName: material.unspscDisplayProperty }, function (data) {
        ...
        $('#OpenGeneralLedgerMappingLookupTableButton').click(function () {
            ...
            _MaterialgeneralLedgerMappingLookupTableModal.open({ id: material.generalLedgerMappingId, displayName: material.generalLedgerMappingDisplayProperty }, function (data) {
                            ...
                            $("#Material_ImageMain_Remove").click(function () {
                                abp.message.confirm(
                                    ...
                                    function (isConfirmed) {
                                        if (isConfirmed) {
                                            var Material = _$materialInformationForm.serializeFormToObject();
                                            _materialsService.removeImageMainFile({
                                                id: Material.id
                                            }).done(function () {
