(function ($) {
    app.modals.CreateOrEditGeneralLedgerMappingModal = function () {
        ...
        this.init = function (modalManager) {
            ...
            _$generalLedgerMappingInformationForm = _modalManager.getModal().find('form[name=GeneralLedgerMappingInformationsForm]');
        ...
        this.save = function () {
            ...
            var generalLedgerMapping = _$generalLedgerMappingInformationForm.serializeFormToObject();
			 ...
			 _generalLedgerMappingsService.createOrEdit(
