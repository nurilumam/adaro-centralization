...
namespace Adaro.Centralize.Web.TagHelpers
{
    ...
    public class CentralizePageSubheaderTagHelper : TagHelper
    {
        ...
        public CentralizePageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
