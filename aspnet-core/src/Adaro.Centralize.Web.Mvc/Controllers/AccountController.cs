...
using Adaro.Centralize.Web.Models.Account;
...
using Adaro.Centralize.Web.Security.Recaptcha;
using Adaro.Centralize.Web.Session;
using Adaro.Centralize.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : CentralizeControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(CentralizeConsts.DateTimeOffsetFormat));
