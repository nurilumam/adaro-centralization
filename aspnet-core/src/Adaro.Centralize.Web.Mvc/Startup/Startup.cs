...
using Adaro.Centralize.Identity;
using Adaro.Centralize.Schemas;
using Adaro.Centralize.Web.Chat.SignalR;
using Adaro.Centralize.Web.Common;
using Adaro.Centralize.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Adaro.Centralize.Web.Swagger;
using Stripe;
...
using Adaro.Centralize.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Adaro.Centralize.Web.Extensions;
using Adaro.Centralize.Web.MultiTenancy;
using SecurityStampValidatorCallback = Adaro.Centralize.Identity.SecurityStampValidatorCallback;
...
namespace Adaro.Centralize.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<CentralizeWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseCentralizeForwardedHeaders();
            }
            else
            {
            ...
            if (CentralizeConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Centralize API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Adaro.Centralize.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "Centralize API", Version = "v1"});
                ...
                var applicationXml = $"Adaro.Centralize.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Adaro.Centralize.Web.Core.xml";
