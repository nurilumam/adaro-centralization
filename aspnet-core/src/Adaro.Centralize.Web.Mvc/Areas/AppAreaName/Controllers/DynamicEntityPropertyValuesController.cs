...
using Adaro.Centralize.Web.Areas.AppAreaName.Models.DynamicEntityPropertyValues;
...
namespace Adaro.Centralize.Web.Areas.AppAreaName.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : CentralizeControllerBase
    {
