...
using Adaro.Centralize.Configuration.Host;
using Adaro.Centralize.Editions;
using Adaro.Centralize.Timing;
using Adaro.Centralize.Timing.Dto;
using Adaro.Centralize.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace Adaro.Centralize.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : CentralizeControllerBase
    {
