...
using Adaro.Centralize.Web.Areas.AppAreaName.Models.Languages;
...
namespace Adaro.Centralize.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : CentralizeControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = CentralizeConsts.LocalizationSourceName;
            }
