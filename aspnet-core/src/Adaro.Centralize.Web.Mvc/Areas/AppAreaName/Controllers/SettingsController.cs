...
using Adaro.Centralize.Configuration.Tenants;
...
using Adaro.Centralize.Web.Areas.AppAreaName.Models.Settings;
...
namespace Adaro.Centralize.Web.Areas.AppAreaName.Controllers
{
    ...
    public class SettingsController : CentralizeControllerBase
    {
