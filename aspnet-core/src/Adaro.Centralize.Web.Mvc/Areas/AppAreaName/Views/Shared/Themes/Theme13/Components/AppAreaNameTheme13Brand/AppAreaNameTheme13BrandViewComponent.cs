...
namespace Adaro.Centralize.Web.Areas.AppAreaName.Views.Shared.Themes.Theme13.Components.AppAreaNameTheme13Brand
{
    public class AppAreaNameTheme13BrandViewComponent : CentralizeViewComponent
    {
