...
namespace Adaro.Centralize.Core.Base
{
    public abstract class CentralizeQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected CentralizeQueryBase(string fieldName,
