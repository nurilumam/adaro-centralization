...
using Adaro.Centralize.Authentication.TwoFactor;
...
using Adaro.Centralize.Web.Authentication.JwtBearer;
using Adaro.Centralize.Web.Authentication.TwoFactor;
using Adaro.Centralize.Web.Chat.SignalR;
using Adaro.Centralize.Web.Common;
using Adaro.Centralize.Web.Configuration;
...
{
    [DependsOn(
        typeof(CentralizeApplicationModule),
        typeof(CentralizeEntityFrameworkCoreModule),
    ...
    public class CentralizeWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CentralizeWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CentralizeApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CentralizeWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CentralizeWebCoreModule).Assembly);
        }
