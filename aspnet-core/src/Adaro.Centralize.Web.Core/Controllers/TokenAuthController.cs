...
using Adaro.Centralize.Authentication.TwoFactor.Google;
...
namespace Adaro.Centralize.Web.Controllers
{
    ...
    public class TokenAuthController : CentralizeControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(CentralizeConsts.DateTimeOffsetFormat));
