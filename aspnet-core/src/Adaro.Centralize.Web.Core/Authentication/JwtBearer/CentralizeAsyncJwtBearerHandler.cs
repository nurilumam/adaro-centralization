...
{
    public class CentralizeAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public CentralizeAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
