...
/// </summary>
public static class CentralizeJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, CentralizeAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
